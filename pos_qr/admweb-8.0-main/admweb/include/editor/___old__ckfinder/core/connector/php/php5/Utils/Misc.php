...
class CKFinder_Connector_Utils_Misc
{
    ...
    public static function setMemoryForImage($imageWidth, $imageHeight, $imageBits, $imageChannels)
    {
        ...
        * $imageChannels / 8
        ...
        $memory_limit_fix = ini_get('memory_limit');
        $memoryLimit = CKFinder_Connector_Utils_Misc::returnBytes((int)$memory_limit_fix)/$MB;
    ...
    public static function returnBytes($val) {
        ...
        $last = strlen((int)$val)-1;
        $last = isset($val[$last]) ? $val[$last] : '';
