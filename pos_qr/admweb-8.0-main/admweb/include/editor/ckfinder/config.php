...
include_once(dirname(dirname(dirname(__FILE__))) . '/conf.ini.php');
if (is_dir(PATH_UPLOAD) && defined(URL_UPLOAD)) {
    $baseUrl = URL_UPLOAD . '/upfiles/';
} else {
    $baseUrl = '/uploads/upfiles/';
}
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => $baseUrl,
    'root'         => PATH_UPLOAD . '/upfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
