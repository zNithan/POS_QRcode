                        ...
                        <div id="demo-theme">
                            ...
                            <div class="clearfix text-center demo-srow-scheme bg-gray-light pad-ver mar-top">
                                <div class="demo-theme-btn col-md-6">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <img src="<?php echo TEMPLATE_URL; ?>/img/color-schemes-e.png">
                                        </div>
                                        <div class="media-body">
                            ...
                            <div class="clearfix text-center">
                                <div class="demo-theme-btn col-md-3 pad-ver">
                                    ...
                                    <div class="mar-btm">
                                        <img src="<?php echo TEMPLATE_URL; ?>/img/color-schemes-a.png" class="img-responsive">
                                    </div>
                                    <div class="demo-justify-theme">
                                ...
                                <div class="demo-theme-btn col-md-3 pad-ver">
                                    ...
                                    <div class="mar-btm">
                                        <img src="<?php echo TEMPLATE_URL; ?>/img/color-schemes-b.png" class="img-responsive">
                                    </div>
                                    <div class="demo-justify-theme">
                                ...
                                <div class="demo-theme-btn col-md-3 pad-ver">
                                    <p class="text-semibold text-uppercase text-xs text-muted">Navigation</p>
                                    <div class="mar-btm">
                                        <img src="<?php echo TEMPLATE_URL; ?>/img/color-schemes-c.png" class="img-responsive">
                                    </div>
                                    <div class="demo-justify-theme">
                                ...
                                <div class="demo-theme-btn col-md-3 pad-ver">
                                    ...
                                    <div class="mar-btm">
                                        <img src="<?php echo TEMPLATE_URL; ?>/img/color-schemes-d.png" class="img-responsive">
                                    </div>
                                    <div class="demo-justify-theme">
