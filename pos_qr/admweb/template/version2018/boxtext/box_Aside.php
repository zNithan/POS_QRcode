			...
			<div class="nano-content">
				<ul class="nav nav-tabs nav-justified">
					<li class="active"><a href="#demo-asd-tab-1" data-toggle="tab"><i
							class="demo-pli-speech-bubble-7 icon-lg"></i></a></li>
					<li><a href="#demo-asd-tab-2" data-toggle="tab"><i
							class="demo-pli-information icon-lg icon-fw"></i> Report </a></li>
					<li><a href="#demo-asd-tab-3" data-toggle="tab"><i
							class="demo-pli-wrench icon-lg icon-fw"></i> Settings </a></li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane fade in active" id="demo-asd-tab-1">
							...
							<a href="#" class="list-group-item">
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/2.png?v=<?php echo CACHE_VERSION; ?>"
								...
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/7.png?v=<?php echo CACHE_VERSION; ?>"
										alt="Profile Picture">
								</div>
								<div class="media-body">
								...
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/1.png?v=<?php echo CACHE_VERSION; ?>"
										alt="Profile Picture"> <i
										class="badge badge-info badge-stat badge-icon pull-left"></i>
								</div>
								<div class="media-body">
								...
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/4.png?v=<?php echo CACHE_VERSION; ?>"
										alt="Profile Picture">
								</div>
								<div class="media-body">
								...
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/8.png?v=<?php echo CACHE_VERSION; ?>"
										alt="Profile Picture"> <i
										class="badge badge-warning badge-stat badge-icon pull-left"></i>
								</div>
								<div class="media-body">
								...
								<div class="media-left pos-rel">
									<img class="img-circle img-xs"
										src="<?php echo TEMPLATE_URL; ?>/img/profile-photos/9.png?v=<?php echo CACHE_VERSION; ?>"
										alt="Profile Picture"> <i
										class="badge badge-danger badge-stat badge-icon pull-left"></i>
								</div>
								<div class="media-body">
						...
						<div class="pad-hor">
							<p>
								Lorem ipsum dolor sit amet, consectetuer <a data-title="45%"
									class="add-tooltip text-semibold text-main" href="#">adipiscing
					...
					<div class="tab-pane fade" id="demo-asd-tab-2">
						<div class="pad-all">
							<p class="pad-ver text-main text-sm text-uppercase text-bold">Billing
								&amp; reports</p>
							<p>
								Get <strong class="text-main">$5.00</strong> off your next bill
								by making sure your full payment reaches us before August 5,
								2018.
							</p>
						</div>
						<hr class="new-section-xs">
						<div class="pad-all">
							<span class="pad-ver text-main text-sm text-uppercase text-bold">Amount
								Due On</span>
						...
						<hr>
						<p class="pad-all text-main text-sm text-uppercase text-bold">Additional
							Actions</p>
						<div class="list-group bg-trans">
							<a href="#" class="list-group-item"><i
								class="demo-pli-information icon-lg icon-fw"></i> Service
								Information</a> <a href="#" class="list-group-item"><i
								class="demo-pli-mine icon-lg icon-fw"></i> Usage Profile</a> <a
								...
								Options</a> <a href="#" class="list-group-item"><i
					...
					<div class="tab-pane fade" id="demo-asd-tab-3">
							...
							<li class="list-group-item">
								<div class="pull-right">
									<input class="toggle-switch" id="demo-switch-1" type="checkbox"
										checked> <label for="demo-switch-1"></label>
								</div>
								<p class="mar-no text-main">Show my personal status</p> <small
								class="text-muted">Lorem ipsum dolor sit amet, consectetuer
									adipiscing elit.</small>
							</li>
							<li class="list-group-item">
								<div class="pull-right">
									<input class="toggle-switch" id="demo-switch-2" type="checkbox"
										checked> <label for="demo-switch-2"></label>
								</div>
								<p class="mar-no text-main">Show offline contact</p> <small
								class="text-muted">Aenean commodo ligula eget dolor. Aenean
									massa.</small>
							</li>
							<li class="list-group-item">
								<div class="pull-right">
								...
								<p class="mar-no text-main">Invisible mode</p> <small
								class="text-muted">Cum sociis natoque penatibus et magnis dis
						...
						<hr>
						<p
							class="pad-hor text-main text-sm text-uppercase text-bold mar-no">Task
							Progress</p>
						<div class="pad-all">
